<h1 align="center">
  ...
  <br>
  HEI-Vs Engineering School - Sem Embedded Systems
  <br>
</h1>
<h1 align="center">
  <br>
...
Welcome to the GitHub organization for the [HEI-Vs Engineering School](https://hevs.ch/synd) in Sion, Switzerland. This organization is dedicated to the course "Sem Embedded Systems" for the orientation Synd aka [Industrial Systems](https://hevs.ch/synd).

## Repositories

Here are the repositories available in this organization:

- [sem-docs](https://github.com/hei-synd-sem/sem-docs): This repository contains all the course materials, including lecture slides, scipts, exercises, laboratory and projects documents.
- [sem-labs](https://github.com/hei-synd-sem/sem-labs): This repository contains additional resources for the laboratories.
- [sem-esc](https://github.com/hei-synd-sem/sem-esc): This repository contains the HDL Project and additional resources for the Semester Project Escape Lab.
